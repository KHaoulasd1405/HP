...
include("./pages/tap_page_callback.jl")
...
#= include("./pages/tab_summary_callback.jl") =#
...
callback!(
    ...
    if tab == "tab-data"
        ...
        return layouts[2],layouts[1],html_h1(""),html_h1(""),html_h1("")
    elseif tab == "tab-summary"
        layouts = build_tab_summary!(app)
        return layouts[2],html_h1(""),layouts[1],html_h1(""),html_h1("")
    elseif tab == "tab-plot"
        layouts = build_plot_page!(app)
        return layouts[1],html_h1(""),html_h1(""),layouts[2],html_h1("")
    elseif tab == "tab-lm"
        layouts = build_linear_tab!(app)
        return layouts[2],html_h1(""),html_h1(""),html_h1(""),layouts[1]
    elseif tab == "tab-about"
        return build_about(),html_h1(""),html_h1(""),html_h1(""),html_h1("")
    end
    return html_h1(""),html_h1(""),html_h1(""),html_h1(""),html_h1("")
end
