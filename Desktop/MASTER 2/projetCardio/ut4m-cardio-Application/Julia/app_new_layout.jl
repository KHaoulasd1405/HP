...
include("./pages/mixedmodel_tab.jl")
include("callbacks/callback_mixed.jl")
...
callback!(
    ...
    elseif tab == "tab-mixed"
        layouts = build_mixed_tab!(app)
